...
def new_scraper():
    ...
    {
        "custom":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.3"
    }
    ]
...
tiempo_aleatorio = random.uniform(tiempo_minimo, tiempo_maximo)

# Imprimir el tiempo de espera aleatorio (opcional)
print(f"Esperando {tiempo_aleatorio:.2f} segundos...")

# Utilizar time.sleep con el tiempo aleatorio
